  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-col md:flex-row justify-evenly items-start space-y-6 md:space-y-0">
      ...
      <div className="space-y-2">
        <h4 className="text-pink-400 font-semibold">Useful Links</h4>
        <ul className="space-y-1">
          <li><a href="#overview" className="text-purple-300 hover:underline">Overview</a></li>
          <li><a href="#sponsors" className="text-purple-300 hover:underline">Sponsors</a></li>
          <li><a href="#judging" className="text-purple-300 hover:underline">Judging</a></li>
          <li><a href="#faqs" className="text-purple-300 hover:underline">FAQs</a></li>
        </ul>
      </div>

      {/* Contact Information */}
      <div className="space-y-2">
        <h4 className="text-pink-400 font-semibold">Contact Us</h4>
        <p className="text-sm">+91 7014151228</p>
        <p className="text-sm">codebase@iiitkota.ac.in</p>
      </div>
